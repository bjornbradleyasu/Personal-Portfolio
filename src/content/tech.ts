...
export const techCategories = {
  audio: {
    ...
    description: 'Game & XR Audio Implementation',
    items: [
      { id: 'tech-fmod', name: 'FMOD Studio', category: 'audio', icon: 'fmod', description: 'Interactive audio engine', proficiency: 'expert' },
      ...
      { id: 'tech-webaudio', name: 'Web Audio API', category: 'audio', icon: 'webaudio', description: 'Browser audio processing & synthesis', proficiency: 'intermediate' },
  ...
  frontend: {
    ...
    items: [
      ...
      { id: 'tech-js', name: 'JavaScript', category: 'frontend', icon: 'javascript', description: 'ES6+ JavaScript', proficiency: 'advanced' },
      { id: 'tech-html', name: 'HTML5', category: 'frontend', icon: 'html', description: 'Semantic HTML markup', proficiency: 'advanced' },
      { id: 'tech-css', name: 'CSS3', category: 'frontend', icon: 'css', description: 'Modern CSS styling & animations', proficiency: 'advanced' },
      { id: 'tech-responsive', name: 'Responsive Design', category: 'frontend', icon: 'responsive', description: 'Mobile-first layouts', proficiency: 'advanced' },
      { id: 'tech-threejs', name: 'Three.js', category: 'frontend', icon: 'threejs', description: '3D rendering in the browser', proficiency: 'intermediate' },
      { id: 'tech-framer', name: 'Framer Motion', category: 'frontend', icon: 'framer', description: 'Animation & interaction library', proficiency: 'advanced' },
  ...
  programming: {
    ...
    items: [
      ...
      { id: 'tech-swift', name: 'Swift', category: 'programming', icon: 'swift', description: 'iOS/macOS & creative apps', proficiency: 'intermediate' }
    ]
  },
  data: {
