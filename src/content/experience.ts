...
export const experiences: Experience[] = [
  {
    id: 'exp-1',
    company: 'Wisconsin Chamber Orchestra',
    role: 'Volunteer',
    startDate: '2017-01',
    endDate: '2020-12',
    achievements: [
      'Supported concert and event operations as a volunteer in a professional orchestra environment.',
      'Contributed to behind-the-scenes coordination that helped performances and community programming run smoothly.',
      'Built early experience working around live production, collaboration, and audience-facing events.'
    ],
    technologies: ['Event Support', 'Live Production', 'Team Collaboration']
  },
  {
    id: 'exp-2',
