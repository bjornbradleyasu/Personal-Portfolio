...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex items-center px-2 lg:px-4">
        <div className="grid lg:grid-cols-[1fr_0.5fr_0.6fr] gap-0 items-center w-full">
          {/* Left: Text Content */}
          ...
          >
            <div className="glass-card border border-white/10 p-6 rounded-xl shadow-glass lg:h-[80vh] lg:max-h-[80vh] flex flex-col">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-fg/60">Tech Stack</p>
                </div>
                ...
                >
                  <div className="flex flex-col gap-3" style={{ paddingBottom: '1rem' }}>
                    {loopingItems.map((tech, index) => (
                      ...
                      >
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-accent-cyan/15 to-accent-sky/25 flex items-center justify-center text-accent-sky">
                          <TechIcon icon={tech.icon} className="w-6 h-6" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-semibold text-fg truncate">{tech.name}</p>
                          <p className="text-xs text-fg/60 truncate capitalize">{tech.proficiency}</p>
                        </div>
